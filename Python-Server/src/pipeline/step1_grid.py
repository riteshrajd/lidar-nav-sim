...
def apply_grid(image_path, output_dir="media/input/grid", grid_size=15):
    """
    Applies a coordinate grid to an image and saves it.
    Returns the path to the newly saved gridded image.
    """
